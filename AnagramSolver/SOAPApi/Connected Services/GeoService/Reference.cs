...
namespace SOAPApi.GeoService {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://www.webservicex.net/", ConfigurationName="GeoService.GeoIPServiceSoap")]
    public interface GeoIPServiceSoap {
        ...
        SOAPApi.GeoService.GeoIP GetGeoIP(string IPAddress);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.webservicex.net/GetGeoIP", ReplyAction="*")]
        System.Threading.Tasks.Task<SOAPApi.GeoService.GeoIP> GetGeoIPAsync(string IPAddress);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.webservicex.net/GetGeoIPContext", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        SOAPApi.GeoService.GeoIP GetGeoIPContext();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://www.webservicex.net/GetGeoIPContext", ReplyAction="*")]
        System.Threading.Tasks.Task<SOAPApi.GeoService.GeoIP> GetGeoIPContextAsync();
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface GeoIPServiceSoapChannel : SOAPApi.GeoService.GeoIPServiceSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class GeoIPServiceSoapClient : System.ServiceModel.ClientBase<SOAPApi.GeoService.GeoIPServiceSoap>, SOAPApi.GeoService.GeoIPServiceSoap {
        ...
        public SOAPApi.GeoService.GeoIP GetGeoIP(string IPAddress) {
            return base.Channel.GetGeoIP(IPAddress);
        }
        
        public System.Threading.Tasks.Task<SOAPApi.GeoService.GeoIP> GetGeoIPAsync(string IPAddress) {
            return base.Channel.GetGeoIPAsync(IPAddress);
        }
        
        public SOAPApi.GeoService.GeoIP GetGeoIPContext() {
            return base.Channel.GetGeoIPContext();
        }
        
        public System.Threading.Tasks.Task<SOAPApi.GeoService.GeoIP> GetGeoIPContextAsync() {
